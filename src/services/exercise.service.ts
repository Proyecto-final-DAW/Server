// Bundled at build-time via `resolveJsonModule`. `tsc` copies the JSON
// next to the compiled output, so the dataset ships as part of the
// deployed artifact and there is no runtime path resolution to get wrong.
