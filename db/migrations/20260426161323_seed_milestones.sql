...
VALUES
  ('Primera sesión', 'Completa tu primera sesión de entrenamiento.', 'TOTAL_SESSIONS', 1, 'medal'),
  ...
  ('En racha', 'Mantén una racha de 3 días consecutivos.', 'STREAK', 3, 'fire'),
  ('Imparable', 'Mantén una racha de 7 días consecutivos.', 'STREAK', 7, 'fire'),
  ('Legendario', 'Mantén una racha de 30 días consecutivos.', 'STREAK', 30, 'fire'),
